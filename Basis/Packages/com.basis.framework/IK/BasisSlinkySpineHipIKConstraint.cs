...
{
	[Serializable]
	public struct BasisSlinkySpineHipIKConstraintData : IAnimationJobData, BasisISlinkySpineHipIKConstraintData
	{
		...
		Vector3 BasisISlinkySpineHipIKConstraintData.rootTargetPosition { get => rootTargetPosition; }
		Vector3 BasisISlinkySpineHipIKConstraintData.rootTargetRotation { get => rootTargetRotation; }
		Vector3 BasisISlinkySpineHipIKConstraintData.midTargetPosition { get => midTargetPosition; }
		Vector3 BasisISlinkySpineHipIKConstraintData.midTargetRotation { get => midTargetRotation; }
		Vector3 BasisISlinkySpineHipIKConstraintData.tipTargetPosition { get => tipTargetPosition; }
		Vector3 BasisISlinkySpineHipIKConstraintData.tipTargetRotation { get => tipTargetRotation; }
		Vector3 BasisISlinkySpineHipIKConstraintData.hintPosition { get => hintPosition; }
		Vector3 BasisISlinkySpineHipIKConstraintData.hintRotation { get => hintRotation; }
		Vector3 BasisISlinkySpineHipIKConstraintData.hintDirection { get => m_HintDirection; }
	...
	public class BasisSlinkySpineHipIKConstraint : RigConstraint<BasisSlinkySpineHipIKConstraintJob, BasisSlinkySpineHipIKConstraintData, BasisSlinkySpineHipIKConstraintJobBinder<BasisSlinkySpineHipIKConstraintData>>
	{
	...
	public struct BasisSlinkySpineHipIKConstraintJob : IWeightedAnimationJob
	{
		...
		public void ProcessAnimation(AnimationStream stream)
		{
			...
			if(w > 0f)
			{
				...
				BasisAnimationRuntimeUtils.SolveSlinkySpineHipIK(stream, root, mid, tip, rootTarget, midTarget, tipTarget, hint, hintWeight.Get(stream), targetOffset, hintTransformOutput);
				return;
			}
	...
	public interface BasisISlinkySpineHipIKConstraintData
	{
		Transform root { get; }
		Transform mid { get; }
		Transform tip { get; }
	...
	public class BasisSlinkySpineHipIKConstraintJobBinder<T> : AnimationJobBinder<BasisSlinkySpineHipIKConstraintJob, T> where T : struct, IAnimationJobData, BasisISlinkySpineHipIKConstraintData
	{
		public override BasisSlinkySpineHipIKConstraintJob Create(Animator animator, ref T data, Component component)
		{
			BasisSlinkySpineHipIKConstraintJob job = new BasisSlinkySpineHipIKConstraintJob
			{
		...
		public override void Destroy(BasisSlinkySpineHipIKConstraintJob job) { }
	}
}
